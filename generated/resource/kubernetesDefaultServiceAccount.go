...
const kubernetesDefaultServiceAccount = `{
  "block": {
    "attributes": {
...
func KubernetesDefaultServiceAccountSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(kubernetesDefaultServiceAccount), &result)
	return &result
}
