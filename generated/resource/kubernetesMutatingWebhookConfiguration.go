...
const kubernetesMutatingWebhookConfiguration = `{
  "block": {
    "attributes": {
      "id": {
        "computed": true,
...
func KubernetesMutatingWebhookConfigurationSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(kubernetesMutatingWebhookConfiguration), &result)
	return &result
}
