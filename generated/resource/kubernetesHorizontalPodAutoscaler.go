...
const kubernetesHorizontalPodAutoscaler = `{
  "block": {
    "attributes": {
      "id": {
        "computed": true,
...
func KubernetesHorizontalPodAutoscalerSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(kubernetesHorizontalPodAutoscaler), &result)
	return &result
}
