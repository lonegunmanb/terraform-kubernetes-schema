...
const kubernetesReplicationController = `{
  "block": {
    "attributes": {
      "id": {
        "computed": true,
...
func KubernetesReplicationControllerSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(kubernetesReplicationController), &result)
	return &result
}
