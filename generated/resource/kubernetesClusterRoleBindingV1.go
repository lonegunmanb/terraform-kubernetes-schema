...
const kubernetesClusterRoleBindingV1 = `{
  "block": {
    "attributes": {
      "id": {
        "computed": true,
...
func KubernetesClusterRoleBindingV1Schema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(kubernetesClusterRoleBindingV1), &result)
	return &result
}
