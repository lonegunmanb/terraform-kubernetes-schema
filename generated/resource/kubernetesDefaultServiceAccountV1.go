...
const kubernetesDefaultServiceAccountV1 = `{
  "block": {
    "attributes": {
...
func KubernetesDefaultServiceAccountV1Schema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(kubernetesDefaultServiceAccountV1), &result)
	return &result
}
