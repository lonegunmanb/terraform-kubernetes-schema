...
const kubernetesPersistentVolumeClaim = `{
  "block": {
    "attributes": {
      "id": {
        "computed": true,
...
func KubernetesPersistentVolumeClaimSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(kubernetesPersistentVolumeClaim), &result)
	return &result
}
