...
const kubernetesValidatingWebhookConfiguration = `{
  "block": {
    "attributes": {
      "id": {
        "computed": true,
...
func KubernetesValidatingWebhookConfigurationSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(kubernetesValidatingWebhookConfiguration), &result)
	return &result
}
