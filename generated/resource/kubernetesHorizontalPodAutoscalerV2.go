...
const kubernetesHorizontalPodAutoscalerV2 = `{
  "block": {
    "attributes": {
      "id": {
        "computed": true,
...
func KubernetesHorizontalPodAutoscalerV2Schema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(kubernetesHorizontalPodAutoscalerV2), &result)
	return &result
}
